        ...
        <div class="admin-layout">
            ...
            <main class="books-content">
                ...
                <div class="books-header">
                    <h2>Manage Books</h2>
                    <button class="btn-add"><a href="addBooks.php">+ Books</a></button>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn-edit"><a href="addBooks.php?id=<?php echo $row['ma_sach']; ?>"
                                                class="btn-edit"
                                                style="text-decoration: none; display: inline-block;">Edit</a></button>

                                        <button class="btn-delete"><a
                                                href="deleteBooks.php?id=<?php echo $row['ma_sach']; ?>" class="btn-delete"
                                                style="text-decoration: none; display: inline-block;"
                                                onclick="return confirm('Bạn có chắc chắn muốn xóa cuốn sách này không?');">Delete</a></button>
